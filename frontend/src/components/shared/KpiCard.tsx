...
export function KpiCard({
  ...
  return (
    <div className={`card-surface bg-surface p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${accentColor ? accentBorders[accentColor] : ""}`}>
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="grid size-10 shrink-0 place-items-center rounded-[var(--radius-control)] bg-raised text-heading [&_svg]:size-5">
